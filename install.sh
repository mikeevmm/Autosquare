...
echo -e "$HOME/bin/"
echo -e "to"
echo -e "$DIR/autosquare"
echo -e "so that you can call autosquare from any directory."
...
if ln -s "$DIR/autosquare.py" "$HOME/bin/autosquare"
then
    echo -e "\033[32mDone.\033[0m"
    echo -e "Call \`autosquare --help\` for more info."
else
